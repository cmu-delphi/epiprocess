---
title: 5. Detect and correct outliers in signals
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{5. Detect and correct outliers in signals}
...
objects. We'll work with state-level daily reported COVID-19 case counts from 
...
plot_outlr = function(x, var, outliers_col = outlier_info, 
...
plot_outlr(x %>% filter(geo_value == "fl"), cases, 
           bands = TRUE, combined_only = FALSE,
           facet_vars = vars(method), scales = "free_y", ncol = 1) +
  scale_x_date(minor_breaks = "month", date_labels = "%b %y") +
  labs(x = "Date", y = "Reported COVID-19 counts")

plot_outlr(x %>% filter(geo_value == "nj"), cases, 
           bands = TRUE, combined_only = FALSE,
           facet_vars = vars(method), scales = "free_y", ncol = 1) +
  scale_x_date(minor_breaks = "month", date_labels = "%b %y") +
  labs(x = "Date", y = "Reported COVID-19 counts")
