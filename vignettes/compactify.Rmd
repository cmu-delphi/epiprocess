...
locf_omitted <- as_epi_archive2(dt)
locf_included <- as_epi_archive2(dt, compactify = FALSE)
...
locf_included_2 <- as_epi_archive2(dt2, compactify = FALSE)
locf_omitted_2 <- as_epi_archive2(dt2, compactify = TRUE)
```
...
slide_median <- function(my_ea) {
  my_ea$slide(median = median(.data$case_rate_7d_av), before = 7)
}
