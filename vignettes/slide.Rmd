...
for a few U.S. states (note: this means *new*, rather than *cumulative* cases) 
using the [`covidcast`](https://cmu-delphi.github.io/covidcast/covidcastR/) 
package, and then convert this to `epi_signal` format.
