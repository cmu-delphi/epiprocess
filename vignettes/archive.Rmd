...
xx = data.table(t = c(rep("a",5), rep("b",5)), v1 = 1:10, v2 = 1:10)
xx[3,2] = NA # Shoud be filled be LOCF
xx[6,3] = NA # Should NOT be filled by LOCF, it's the first one in group b
xx[10,2:3] = NA # shuld both be filled by LOCF
xx
fillvars <- c("v1", "v2")
