---
title: 7. Work with data archives and produce snapshots 
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{7. Work with data archives and produce snapshots}
...
arch1 = epi_archive$new(df)
arch2 = as_epi_archive(df)
arch3 = new_epi_archive(df$geo_value, df$time_value, df$version, value = df$value)
```
