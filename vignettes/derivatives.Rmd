...
The `estimate_deriv()` function operates on a `epi_tibble` object, and aside 
...
x <- estimate_deriv(x, case_rates, method = "ss", n = 28, 
                    new_col_name = "deriv_ss1", df = 8)    
x <- estimate_deriv(x, case_rates, method = "ss", n = 28, 
                    new_col_name = "deriv_ss2", cv = TRUE)
...
x <- estimate_deriv(x, case_rates, method = "tf", n = 28, 
                    new_col_name = "deriv_tf1", df = 8) 
x <- estimate_deriv(x, case_rates, method = "tf", n = 28, 
                    new_col_name = "deriv_tf2", cv = TRUE)
