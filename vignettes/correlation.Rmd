---
title: 3. Correlate signals over space and time
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{3. Correlate signals over space and time}
...
problem at hand (but in another setting, we may want to group by, say, geo value 
and age before time shifting).
