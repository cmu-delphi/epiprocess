...
document](https://cmu-delphi.github.io/epiprocess/dev/pull_request_template.md).
...
results](https://cran.rstudio.org/web/checks/check_results_epiprocess.html).
...
[Polish
NEWS](https://github.com/cmu-delphi/epiprocess/blob/dev/NEWS.md).
