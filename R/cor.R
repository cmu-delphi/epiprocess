#' Compute correlations between variables in an `epi_tibble` object
#'
#' Computes correlations between variables in an `epi_tibble` object, allowing
